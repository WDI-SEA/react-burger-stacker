...
function App() {
  // use state hook to track updatye of ingredient data
...
function addToStack(e) {
  ...
  // get burgerSeed ingredient from user click event
  let result = e.target.innerText
  // add clicked burgerSeed ingredients to setBurgerPaneIngredients
