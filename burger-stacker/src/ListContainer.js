...
const ListContainer = props => {
    ...
    const addIngredient = (e, ingredientName) => {
        e.preventDefault()
        setSelectedIngredients([ingredientName, ...selectedIngredients])
    ...
    return (
        <div className='bothLists'>
            ...
            <BurgerPane selectedIngredients={selectedIngredients} clearList={clearList} />
        </div>
    )
